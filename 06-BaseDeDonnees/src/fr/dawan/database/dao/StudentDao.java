...
public class StudentDao {
	...
	public static List<Student> findByName(String name, Connection cnx, boolean closeCnx) throws Exception {
	...
	//surcharger la méthode findAll
	public static List<Student> findAll(Connection cnx, boolean willBeClosed ) throws Exception {
		List<Student> studentsList = new ArrayList();
