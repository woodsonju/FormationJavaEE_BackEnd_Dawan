	...
	<ul>
                    ...
                    <c:if test="${sessionScope.forname eq null}">
                        <ul class="pull-right right-menu" style="margin-top:-15px">
                            <li  class="fh5co-cta-btn" style="display:inline"><a href="user?action=login">Login</a></li>
                            <li class="fh5co-cta-btn" style="display:inline"><a href="user?action=signUp">Sign up</a></li>
                        </ul>

                    </c:if>
                    <c:if test="${sessionScope.forname ne null}">
                        <ul class="pull-right right-menu">
                            <li class="fh5co-cta-btn"><a href="user?action=deconnect">Deconnection</a></li>
                        </ul>
